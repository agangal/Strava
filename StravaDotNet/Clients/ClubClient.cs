...
namespace StravaDotNet
{
    ...
    public class ClubClient
    {
        ...
        {
            string getUrl = string.Format("{0}/{1}?access_token={2}", Endpoints.Club, clubId, AuthSettings.ScopeAccessToken);
        ...
        {
            string getUrl = string.Format("{0}?access_token={1}", Endpoints.Clubs, AuthSettings.ScopeAccessToken);
            string json = await StravaUWP.Helper.HttpHelper.GetRequestAsync(getUrl); ;
        ...
        {
            string getUrl = string.Format("{0}/{1}/members?access_token={2}", Endpoints.Club, clubId, AuthSettings.ScopeAccessToken);
            string json = await StravaUWP.Helper.HttpHelper.GetRequestAsync(getUrl); ;
        ...
        {
            string getUrl = string.Format("{0}/{1}/activities?access_token={2}", Endpoints.Club, clubId, AuthSettings.ScopeAccessToken);
            string json = await StravaUWP.Helper.HttpHelper.GetRequestAsync(getUrl); ;
        ...
        {
            string postUrl = string.Format("https://www.strava.com/api/v3/clubs/{0}/join?access_token={1}", clubId, AuthSettings.ScopeAccessToken);
        ...
        {
            string postUrl = string.Format("https://www.strava.com/api/v3/clubs/{0}/leave?access_token={1}", clubId, AuthSettings.ScopeAccessToken);
            await StravaUWP.Helper.HttpHelper.PostRequestAsync(postUrl); ;
        }

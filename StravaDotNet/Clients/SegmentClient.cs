...
namespace StravaDotNet
{
    ...
    public class SegmentClient
    {
        ...
        {
            string getUrl = string.Format("{0}/{1}/koms?access_token={2}", Endpoints.Athletes, athleteId, AuthSettings.ScopeAccessToken);
            string json = await StravaUWP.Helper.HttpHelper.GetRequestAsync(getUrl);;
        ...
        {
            string getUrl = string.Format("{0}/?access_token={1}", Endpoints.Starred, AuthSettings.ScopeAccessToken);
            string json = await StravaUWP.Helper.HttpHelper.GetRequestAsync(getUrl);;
        ...
        {
            string getUrl = string.Format("https://www.strava.com/api/v3/athletes/{0}/segments/starred/?access_token={1}", athleteId, AuthSettings.ScopeAccessToken);
            string json = await StravaUWP.Helper.HttpHelper.GetRequestAsync(getUrl);;
        ...
        {
            string getUrl = string.Format("{0}/{1}/leaderboard?filter=overall&access_token={2}", Endpoints.Leaderboard, segmentId, AuthSettings.ScopeAccessToken);
            string json = await StravaUWP.Helper.HttpHelper.GetRequestAsync(getUrl);;
        ...
        public ExplorerResult ExploreSegments(Coordinate southWest, Coordinate northEast)
        {
            ...
            string getUrl = string.Format("{0}/explore?bounds={1}&access_token={2}", Endpoints.Leaderboard, bnds, AuthSettings.ScopeAccessToken);
            string json = HttpHelper.GetRequest(getUrl);
        ...
        public ExplorerResult ExploreSegments(Coordinate southWest, Coordinate northEast, int minCat, int maxCat)
        {
            ...
            string getUrl = string.Format("{0}/explore?bounds={1}&min_cat={2}&max_cat={3}&access_token={4}",
                Endpoints.Leaderboard, bnds, minCat, maxCat, AuthSettings.ScopeAccessToken);
            string json = HttpHelper.GetRequest(getUrl);
        ...
        {
            string getUrl = string.Format("{0}/{1}?access_token={2}", Endpoints.Leaderboard, segmentId, AuthSettings.ScopeAccessToken);
            string json = HttpHelper.GetRequest(getUrl);

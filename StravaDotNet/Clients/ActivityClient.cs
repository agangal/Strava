...
namespace StravaDotNet
{
    ...
    public class ActivityClient
    {
        ...
        {
            string getUrl = string.Format("{0}/{1}?include_all_efforts={2}&access_token={3}", Endpoints.Activity, id, includeEfforts, AuthSettings.ScopeAccessToken);
        ...
        public async Task<Activity> CreateActivityAsync(string name, ActivityType type, DateTime dateTime, int elapsedSeconds, string description, float distance = 0f)
        {
            ...
            string postUrl = string.Format("https://www.strava.com/api/v3/activities?name={0}&type={1}&start_date_local={2}&elapsed_time={3}&description={4}&distance={5}&access_token={6}",
                name, t, timeString, elapsedSeconds, description, distance.ToString(CultureInfo.InvariantCulture), AuthSettings.ScopeAccessToken);
            
                        string json = await StravaUWP.Helper.HttpHelper.PostRequestAsync(postUrl);
        ...
        {
            string getUrl = string.Format("{0}/{1}/comments?access_token={2}", Endpoints.Activity, activityId, AuthSettings.ScopeAccessToken);
            string json = await StravaUWP.Helper.HttpHelper.GetRequestAsync(getUrl);;
        ...
        public async void DeleteActivity(string activityId)
        {
            ...
            string deleteUrl = string.Format("https://www.strava.com/api/v3/activities/{0}?access_token={1}", activityId, AuthSettings.ScopeAccessToken);

            await HttpHelper.DeleteRequestAsync(deleteUrl);
        }
        ...
        {
            string getUrl = string.Format("{0}/{1}/kudos?access_token={2}", Endpoints.Activity, activityId, AuthSettings.ScopeAccessToken);
            string json = await StravaUWP.Helper.HttpHelper.GetRequestAsync(getUrl);;
        ...
        {
            string getUrl = string.Format("{0}/{1}/zones?access_token={2}", Endpoints.Activity, activityId, AuthSettings.ScopeAccessToken);
            string json = await StravaUWP.Helper.HttpHelper.GetRequestAsync(getUrl);;
        ...
        public async void GiveKudos(string activityId)
        {
            ...
            await StravaUWP.Helper.HttpHelper.PostRequestAsync(postUrl);;
        }
